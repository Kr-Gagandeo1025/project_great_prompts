    ...
    <section className="w-full max-w-full flex-start flex-col">
      ...
      >
        <label>
          ...
          placeholder="Write title here..." required className="form_input"/>
        </label>
        <label>
          <span className="font-satoshi font-semibold text-base text-gray-700">
            Your AI Prompt
          ...
          placeholder="Write your prompts here..." required className="form_textarea"/>
        </label>
        <label>
          <span className="font-satoshi font-semibold text-base text-gray-700">
            Tag
        ...
        <div className="flex-end mx-3 mb-5 gap-4">
          ...
          <button type="submit" disabled={submitting} className="px-5 py-1.5 text-sm rounded-full text-white bg-orange-600">
